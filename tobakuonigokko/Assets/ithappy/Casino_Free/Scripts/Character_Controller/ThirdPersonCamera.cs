...
namespace Controller
{
    ...
    {
        [Header("The distance from the player's pivot point upward that will be applied when the camera zooms in")]
        ...
        protected override void SetInput(CameraInputData cameraInputData)
        {
            base.SetInput(cameraInputData);
